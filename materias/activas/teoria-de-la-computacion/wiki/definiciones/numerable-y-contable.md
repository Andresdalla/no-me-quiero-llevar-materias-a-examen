...
**Definición 15.** "Un conjunto A es *numerable* si `A ∼ N` (existe
una biyección `f : N → A`)."

**Definición 16.** "Un conjunto A es *contable* si `A ⪯ N`."

Interpretación: "Un conjunto numerable puede listarse **sin
repeticiones**: `a₀, a₁, a₂, …`. Un conjunto contable puede enumerarse **permitiendo
repeticiones**."

**Proposición 5.** "Todo conjunto numerable es contable."

**Proposición 6.** "Si A es contable e infinito, entonces A es
numerable."

**Las dos fuentes coinciden acá.** **Definición 3.2.** "A es
...
Caracterización por listas (`?15`), útil para razonar rápido:
...
El ejercicio `?14` dice "Demostrar que si un conjunto es contable
...
Demostración de la Proposición 5: "Si A es numerable, existe una
