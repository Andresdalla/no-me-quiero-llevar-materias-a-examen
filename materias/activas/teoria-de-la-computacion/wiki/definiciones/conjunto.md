...
✅ [revision-conjuntos p.1] "Un conjunto es una colección de elementos"

✅ [revision-conjuntos p.1] "Pertenencia: x es un elemento del conjunto A" — `x ∈ A`

✅ [revision-conjuntos p.1] "Conjunto vacío" — `∅ = {}`

**Axioma de extensión.** ✅ [revision-conjuntos p.1] "Dos conjuntos son iguales si y sólo si
tienen los mismos elementos"

**Inclusión amplia.** ✅ [revision-conjuntos p.2] `A ⊆ B ⇔ (∀x ∈ A)(x ∈ B)`

✅ [revision-conjuntos p.2] Propiedades:
...
✅ [revision-conjuntos p.1] `1 ∈ {1, 2, 3}`

✅ [revision-conjuntos p.1] Por el axioma de extensión, ni el orden ni la repetición importan:
...
✅ [revision-conjuntos p.2] `{1} ⊆ {2, 1}`

## Contraejemplo

✅ [revision-conjuntos p.1] `{{1, 2}} ≠ {1, 2}`
...
✅ [revision-conjuntos p.2] El apunte deja abierta la pregunta `{{1, 2}} ⊆ {1, 2}?`
