...
El "ejercicio precedente" es el `?7`: "Demostrar que una
...
"La formalización de este argumento exige hacer precisa la
...
- **El problema** — numerabilidad-diag p.1
- **Criterio de decisión** — numerabilidad-diag p.1 · incluye comentario del sistema
- **El argumento final, en la versión de esta fuente** — numerabilidad-diag p.10, p.5 · incluye comentario del sistema
