...
✅ [numerabilidad-diag p.1] "Numerabilidad y diagonalización", **E. Copello · Á. Tasistro**,
...
Declara su objetivo desde la primera página y lo cumple: ✅ [p.1] "El propósito final del
...
⚠️ La segunda divergencia da **funciones distintas**: `f(1,0) = 2` acá y `π(1,0) = 1` allá.
Ver [[construcciones/emparejamiento-de-cantor]].

⚠️ ✅ [p.7] El ejercicio `?14` usa la palabra "**enumerable**", que no aparece definida en
