...
- Para la Proposición 7: "todo programa válido es una palabra finita
...
"Como no se utiliza el dígito 0, distintas palabras producen números
...
**Ejemplo 3.2 (Palabras).** "Dado un alfabeto finito `Σ`, el
...
Y la conclusión sobre programas, encadenada: "el conjunto formado
...
- **Enunciado** — notas-conjuntos p.6, p.7
- **Hipótesis** — notas-conjuntos p.6, p.7
- **Demostración** — notas-conjuntos p.6, p.7 · incluye comentario del sistema
- **La segunda fuente da la misma prueba, sin fórmula** — numerabilidad-diag p.8 · incluye comentario del sistema
