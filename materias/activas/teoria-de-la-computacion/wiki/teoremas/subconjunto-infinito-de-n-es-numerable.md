...
✅ [notas-conjuntos p.4] **Teorema 1.** "Todo subconjunto infinito de `N` es numerable."

## Hipótesis

- `S ⊆ N` ✅ [notas-conjuntos p.4]
- `S` es infinito ✅ [notas-conjuntos p.4]
...
✅ [notas-conjuntos p.4] "Sea `S ⊆ N` un subconjunto infinito. Como todo subconjunto no vacío
...
✅ [notas-conjuntos p.4] "Esto está bien definido porque S es infinito y, por lo tanto, al
