...
✅ [numerabilidad-diag p.7] **Teorema 3.1.**
...
✅ [numerabilidad-diag p.7] "Las demostraciones constituyen un ejercicio difícil."

## Hipótesis

- Parte 1: `A` infinito ✅ [numerabilidad-diag p.7]
- Parte 2: `A` infinito **y** `A ⪯ B` ✅ [numerabilidad-diag p.7]
...
**Sin demostración en la fuente.** ✅ [numerabilidad-diag p.7] la cátedra las declara "un
...
- ⚠️ La parte 3 usa `{1, …, n}` (empezando en 1), mientras que
  ✅ [notas-conjuntos p.9] el ejercicio sobre `Nₖ` lo define como `Nₖ = {0, 1, 2 … k}`
